...
def modem(binary_vector, modulation_type="QAM", M=16, code_label="Binary"):
    ...
    plot_constellation(modulation_type, mod_symbols, M, MEDIA_MODEM_PATH, code_label=code_label, filename=f"{modulation_type}_{M}_{code_label}_constellation.png")
